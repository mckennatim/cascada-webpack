	...
	var Pond = new React.createClass({
		...
		render: function render() {
			...
			return React.createElement(
				...
				React.createElement('input', { type: 'range', min: '0', max: '120', step: '1', value: this.state.value, onChange: this.handleChange }),
				React.createElement('br', null)
			);
		}
		...
		render: function render() {
			...
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement('br', null),
					React.createElement('br', null),
					React.createElement('input', { type: 'range', min: '0', max: '120', step: '1', value: this.state.value, onChange: this.handleRangeChange })
				),
				React.createElement('br', null)
			);
		}
