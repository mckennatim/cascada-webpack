...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createElement(
	  ...
	  React.createElement(Route, { name: 'reg', path: '/reg', handler: Reg }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Spot = new React.createClass({
		...
		radioLand: function radioLand() {
			...
			if (this.waitSlide) {} else if (state == 'on') {
				this.rbut = 'on';
				this.tval = '';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactAddons = __webpack_require__(221);
	...
	var _servicesAuthService = __webpack_require__(242);
	...
	var Signup = (function (_React$Component) {
	  function Signup() {
	    ...
	    this.state = {
	      apikiey: '',
	      username: _servicesAuthService2['default'].data.username,
	      email: _servicesAuthService2['default'].data.email
	    };
	  }
	  ...
	  _createClass(Signup, [{
	    ...
	    value: function signup(e) {
	      e.preventDefault();
	      _servicesAuthService2['default'].getToken(this.state.user, this.state.email, this.state.extra)['catch'](function (err) {
	      ...
	      return _reactAddons2['default'].createElement(
	        ...
	        _reactAddons2['default'].createElement(
	          ...
	          _reactAddons2['default'].createElement(
	            ...
	            _reactAddons2['default'].createElement('input', { type: 'email', valueLink: this.linkState('email'), className: 'form-control', id: 'email', ref: 'email', placeholder: 'Email' })
	          ),
	          _reactAddons2['default'].createElement(
	            'div',
	            { className: 'form-group' },
	            ...
	            _reactAddons2['default'].createElement('input', { type: 'text', valueLink: this.linkState('apikey'), className: 'form-control', id: 'email', ref: 'email', placeholder: 'apikey' })
	          ),
	          _reactAddons2['default'].createElement(
	            'button',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var cloneWithProps = __webpack_require__(230);
	...
	if ("production" !== process.env.NODE_ENV) {
	  ...
	  React.addons.TestUtils = __webpack_require__(238);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactElement = __webpack_require__(11);
	var ReactPropTransferer = __webpack_require__(231);
...
/***/ function(module, exports) {
	...
	var AuthService = (function () {
	  ...
	  _createClass(AuthService, [{
	    ...
	    key: 'getToken',
	    value: function getToken(username, email, apikey) {
	      return {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _servicesAuthData = __webpack_require__(244);

	var _servicesAuthData2 = _interopRequireDefault(_servicesAuthData);
	...
	var Signup = (function (_React$Component) {
	  ...
	  _createClass(Signup, [{
	    ...
	    value: function signup(e) {
	      e.preventDefault();
	      console.log(_servicesAuthData2['default'].dog);
	      _servicesAuthData2['default'].signup();
	      ...
	      return _reactAddons2['default'].createElement(
	        ...
	        _reactAddons2['default'].createElement(
	          ...
	          _reactAddons2['default'].createElement(
	            ...
	            _reactAddons2['default'].createElement('input', { type: 'email', valueLink: this.linkState('email'), className: 'form-control', id: 'email', ref: 'password', placeholder: 'Password' })
	          ),
	          _reactAddons2['default'].createElement(
	            'button',
	            { type: 'submit', className: 'btn btn-default', onClick: this.signup.bind(this) },
